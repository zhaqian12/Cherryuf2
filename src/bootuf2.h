...
#ifndef BOOTUF2_DATE
  #define BOOTUF2_DATE __DATE__
#endif
#ifndef BOOTUF2_TIME
  #define BOOTUF2_TIME __TIME__
#endif

#define BOOTUF2_YEAR_INT (         \
    (BOOTUF2_DATE[7u] - '0') * 1000u + \
    (BOOTUF2_DATE[8u] - '0') * 100u +  \
    (BOOTUF2_DATE[9u] - '0') * 10u +   \
    (BOOTUF2_DATE[10u] - '0') * 1u)

#define BOOTUF2_MONTH_INT (                                      \
    (BOOTUF2_DATE[2u] == 'n' && BOOTUF2_DATE[1u] == 'a')   ? 1u  /*Jan*/ \
    : (BOOTUF2_DATE[2u] == 'b')                        ? 2u  /*Feb*/ \
    : (BOOTUF2_DATE[2u] == 'r' && BOOTUF2_DATE[1u] == 'a') ? 3u  /*Mar*/ \
    : (BOOTUF2_DATE[2u] == 'r')                        ? 4u  /*Apr*/ \
    : (BOOTUF2_DATE[2u] == 'y')                        ? 5u  /*May*/ \
    : (BOOTUF2_DATE[2u] == 'n')                        ? 6u  /*Jun*/ \
    : (BOOTUF2_DATE[2u] == 'l')                        ? 7u  /*Jul*/ \
    : (BOOTUF2_DATE[2u] == 'g')                        ? 8u  /*Aug*/ \
    : (BOOTUF2_DATE[2u] == 'p')                        ? 9u  /*Sep*/ \
    : (BOOTUF2_DATE[2u] == 't')                        ? 10u /*Oct*/ \
    : (BOOTUF2_DATE[2u] == 'v')                        ? 11u /*Nov*/ \
                                                   : 12u /*Dec*/)

#define BOOTUF2_DAY_INT (                                  \
    (BOOTUF2_DATE[4u] == ' ' ? 0 : BOOTUF2_DATE[4u] - '0') * 10u + \
    (BOOTUF2_DATE[5u] - '0'))

#define BOOTUF2_HOUR_INT ( \
    (BOOTUF2_TIME[0u] == '?' ? 0 : BOOTUF2_TIME[0u] - '0') * 10u + (BOOTUF2_TIME[1u] == '?' ? 0 : BOOTUF2_TIME[1u] - '0'))

#define BOOTUF2_MINUTE_INT ( \
    (BOOTUF2_TIME[3u] == '?' ? 0 : BOOTUF2_TIME[3u] - '0') * 10u + (BOOTUF2_TIME[4u] == '?' ? 0 : BOOTUF2_TIME[4u] - '0'))

#define BOOTUF2_SECONDS_INT ( \
    (BOOTUF2_TIME[6u] == '?' ? 0 : BOOTUF2_TIME[6u] - '0') * 10u + (BOOTUF2_TIME[7u] == '?' ? 0 : BOOTUF2_TIME[7u] - '0'))
